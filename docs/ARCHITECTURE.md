...
**Status:** In progress — PR1 (segmentação, migration 000017/000018) e **PR2 (identidade)** entregues; PR3 (2FA) e PR4 (OAuth + `AUTH_ENABLED=1` por padrão) pendentes. **Supersede o ADR-3** ("Sem auth no MVP"). Detalhe de implementação em [`docs/SDD-AUTH-RBAC.md`](SDD-AUTH-RBAC.md).
