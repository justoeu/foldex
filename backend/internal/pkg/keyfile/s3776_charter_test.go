...
func TestS3776Charter_LoadEnvValueWinsAndIsValidated(t *testing.T) {
	t.Parallel()
	logger := quietLogger()
...
func TestS3776Charter_LoadWithoutAutogenerate(t *testing.T) {
	t.Parallel()
	cfg := baseConfig()
...
func TestS3776Charter_LoadEphemeralAllowedVsRefused(t *testing.T) {
	t.Parallel()
	logger := quietLogger()
	ok := baseConfig()
...
func TestS3776Charter_LoadInvalidPersistedKeyIsNotReplaced(t *testing.T) {
	t.Parallel()
