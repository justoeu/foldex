...
> Stack: **Go 1.26 (Chi · pgx) · PostgreSQL 18 · RustFS · Vite 8 + React 19 + TypeScript 7 + bun · TanStack Query · Tiptap 3 · react-i18next (en/pt/es) · Vitest 5**. Versioning policy + invariants in [`CLAUDE.md`](CLAUDE.md).
